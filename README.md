...
خلاصهٔ هر شهر اختلاف قیمت درون‌محله‌ای پارکینگ، آسانسور، انباری و بالکن را جداگانه
می‌دهد؛ همهٔ این اختلاف‌ها مشاهده‌ای‌اند و اثر علت‌ومعلولی یا جمع‌پذیر نیستند.
